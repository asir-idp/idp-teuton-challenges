...
group "Install Windows 7 on a VBox virtual machine" do
  ...
  goto :host1, :exec => "powershell -command (Get-WmiObject -Class Win32_ComputerSystem).TotalPhysicalMemory -eq 2147016704"
  expect "True"
  ...
  goto :host1, :exec => 'systeminfo | findstr /c:"Zona horaria"'
  expect "(UTC) Dublín, Edimburgo, Lisboa, Londres"

  target "Install Guest Additions on the virtual machine"
  goto :host1, :exec => 'powershell -command Get-ItemProperty HKLM:\\Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\* | Select-Object PSCHildName'
